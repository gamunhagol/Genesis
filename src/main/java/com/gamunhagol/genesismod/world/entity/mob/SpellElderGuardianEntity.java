...
public class SpellElderGuardianEntity extends ElderGuardian {
    private LivingEntity caster;
    private LivingEntity forcedTarget;
    private DamageSnapshot snapshot;
    private int customAttackDuration = 60;

    public SpellElderGuardianEntity(EntityType<? extends ElderGuardian> type, Level level) {
        super(type, level);
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(1, new SpellElderGuardianBeamGoal(this));
    }
    ...
    class SpellElderGuardianBeamGoal extends Goal {
        private final SpellElderGuardianEntity guardian;
        private int attackTime;

        public SpellElderGuardianBeamGoal(SpellElderGuardianEntity guardian) {

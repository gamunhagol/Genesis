        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public HumanoidModel<?> getHumanoidArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlot armorSlot, HumanoidModel<?> playerModel) {
                ...
                return switch (armorSlot){
                    ...
                    case HEAD -> RegisterModels.ISIS_HOLY_KNIGHT_HELMET_MODEL;
                    case CHEST -> RegisterModels.ISIS_HOLY_KNIGHT_CHESTPLATE_MODEL;
                    case LEGS -> RegisterModels.ISIS_HOLY_KNIGHT_LEGGINGS_MODEL;
                    case FEET -> RegisterModels.ISIS_HOLY_KNIGHT_BOOTS_MODEL;

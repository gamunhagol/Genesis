...
public class CarbonizedArmor extends GenesisArmorItem {
    public CarbonizedArmor(ArmorMaterial pMaterial, Type pType, Properties pProperties) {
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public HumanoidModel<?> getHumanoidArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlot armorSlot, HumanoidModel<?> playerModel) {
                ...
                return switch (armorSlot) {
                    case HEAD -> RegisterModels.CARBONIZED_HELMET_MODEL;
                    case CHEST -> RegisterModels.CARBONIZED_CHESTPLATE_MODEL;
                    case LEGS -> RegisterModels.CARBONIZED_LEGGINGS_MODEL;
                    case FEET -> RegisterModels.CARBONIZED_BOOTS_MODEL;
                    default -> null;
                };
            }
        });

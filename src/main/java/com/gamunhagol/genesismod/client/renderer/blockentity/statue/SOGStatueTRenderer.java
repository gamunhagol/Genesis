...
import com.gamunhagol.genesismod.client.model.block.statue.SOGStatueTModel;
...
public class SOGStatueTRenderer implements BlockEntityRenderer<GodStatueGenericBlockEntity> {
    private final SOGStatueTModel model;
    private static final ResourceLocation TEXTURE = new ResourceLocation(GenesisMod.MODID, "textures/block/statue_of_god_t.png");

    public SOGStatueTRenderer(BlockEntityRendererProvider.Context context) {
        this.model = new SOGStatueTModel(context.bakeLayer(ModModelLayers.STATUE_GOD_T_LAYER));
    }

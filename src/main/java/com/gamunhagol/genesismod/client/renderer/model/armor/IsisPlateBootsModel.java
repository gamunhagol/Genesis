...
public class IsisPlateBootsModel <T extends LivingEntity> extends HumanoidModel<T> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(GenesisMod.MODID, "isis_plate_boots"), "main");

    public IsisPlateBootsModel(ModelPart pRoot) {
        super(pRoot);
    }

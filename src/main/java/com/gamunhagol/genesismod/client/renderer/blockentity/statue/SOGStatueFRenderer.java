...
import com.gamunhagol.genesismod.client.model.block.statue.SOGStatueFModel;
...
public class SOGStatueFRenderer implements BlockEntityRenderer<GodStatueGenericBlockEntity> {
    private final SOGStatueFModel model;

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(GenesisMod.MODID, "textures/block/statue_of_god_f.png");

    public SOGStatueFRenderer(BlockEntityRendererProvider.Context context) {
        this.model = new SOGStatueFModel(context.bakeLayer(ModModelLayers.STATUE_GOD_F_LAYER));
    }

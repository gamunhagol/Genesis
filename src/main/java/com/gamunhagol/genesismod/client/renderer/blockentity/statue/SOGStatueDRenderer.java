...
import com.gamunhagol.genesismod.client.model.block.statue.SOGStatueDModel;
...
public class SOGStatueDRenderer implements BlockEntityRenderer<GodStatueGenericBlockEntity> {
    private final SOGStatueDModel model;

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(GenesisMod.MODID, "textures/block/statue_of_god_d.png");

    public SOGStatueDRenderer(BlockEntityRendererProvider.Context context) {
        this.model = new SOGStatueDModel(context.bakeLayer(ModModelLayers.STATUE_GOD_D_LAYER));
    }

...
import com.gamunhagol.genesismod.client.model.block.statue.SOGStatueHModel;
...
public class SOGStatueHRenderer implements BlockEntityRenderer<GodStatueGenericBlockEntity> {
    private final SOGStatueHModel model;

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(GenesisMod.MODID, "textures/block/statue_of_god_h.png");

    public SOGStatueHRenderer(BlockEntityRendererProvider.Context context) {
        this.model = new SOGStatueHModel(context.bakeLayer(ModModelLayers.STATUE_GOD_H_LAYER));
    }

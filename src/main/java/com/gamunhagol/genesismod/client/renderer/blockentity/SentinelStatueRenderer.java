...
public class SentinelStatueRenderer implements BlockEntityRenderer<StatueBlockEntity> {
    ...
    public SentinelStatueRenderer(BlockEntityRendererProvider.Context context) {

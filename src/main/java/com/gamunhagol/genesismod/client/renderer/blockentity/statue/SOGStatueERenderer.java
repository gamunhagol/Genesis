...
import com.gamunhagol.genesismod.client.model.block.statue.SOGStatueEModel;
...
public class SOGStatueERenderer implements BlockEntityRenderer<GodStatueGenericBlockEntity> {
    private final SOGStatueEModel model;

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(GenesisMod.MODID, "textures/block/statue_of_god_e.png");

    public SOGStatueERenderer(BlockEntityRendererProvider.Context context) {
        this.model = new SOGStatueEModel(context.bakeLayer(ModModelLayers.STATUE_GOD_E_LAYER));
    }

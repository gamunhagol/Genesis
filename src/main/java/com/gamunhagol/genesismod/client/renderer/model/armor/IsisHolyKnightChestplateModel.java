...
public class IsisHolyKnightChestplateModel<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public static LayerDefinition createArmorLayer() {
        ...
        PartDefinition chest = body.addOrReplaceChild("chest", CubeListBuilder.create()
                .texOffs(16,112).addBox(-4.0F,-24.0F,-2.0F, 8.0F,12.0F,4.0F, new CubeDeformation(0.5F))
        ...
        PartDefinition outside_rid = body.addOrReplaceChild("outside_rid", CubeListBuilder.create()
                .texOffs(72,90).addBox(-5.0F,-19.0F,-3.0F,10.0F,8.0F,6.0F, new CubeDeformation(-0.16F))
                        .texOffs(72,62).addBox(-5.0F,-20.0F,-3.0F,10.0F,8.0F,6.0F, new CubeDeformation(-0.15F))
                        .texOffs(72,62).addBox(-5.0F,-23.0F,-3.0F,10.0F,8.0F,6.0F, new CubeDeformation(-0.14F))
                        .texOffs(72,62).addBox(-5.0F,-26.0F,-3.0F,10.0F,8.0F,6.0F, new CubeDeformation(-0.13F))
                        .texOffs(72,36).addBox(-5.0F,-27.0F,-3.0F,10.0F,6.0F,6.0F, new CubeDeformation(-0.14F))
                , PartPose.offset(0.0F,24.0F,0.0F));

        PartDefinition inside_rid = body.addOrReplaceChild("inside_rid", CubeListBuilder.create()
                .texOffs(72,76).addBox(-5.0F,-19.0F,-3.0F,10.0F,8.0F,6.0F, new CubeDeformation(-0.165F))
                        .texOffs(72,48).addBox(-5.0F,-20.0F,-3.0F,10.0F,8.0F,6.0F, new CubeDeformation(-0.155F))
                        .texOffs(72,48).addBox(-5.0F,-23.0F,-3.0F,10.0F,8.0F,6.0F, new CubeDeformation(-0.145F))
                        .texOffs(72,48).addBox(-5.0F,-26.0F,-3.0F,10.0F,8.0F,6.0F, new CubeDeformation(-0.135F))
                , PartPose.offset(0.0F,24.0F,0.0F));



        PartDefinition right_armor = right_arm.addOrReplaceChild("right_armor", CubeListBuilder.create()
                .texOffs(40,112).addBox(-3.25F,-0.2F,-2.0F,4.0F,12.0F,4.0F, new CubeDeformation(0.3F))
                        .texOffs(39,79).addBox(-3.25F,6.2F,-2.0F,5.0F,6.0F,4.0F, new CubeDeformation(0.4F))
                        .texOffs(39,79).addBox(-3.25F,4.2F,-2.0F,5.0F,6.0F,4.0F, new CubeDeformation(0.5F))
                        .texOffs(39,79).addBox(-3.25F,2.2F,-2.0F,5.0F,6.0F,4.0F, new CubeDeformation(0.6F))
        ...
        PartDefinition left_armor = left_arm.addOrReplaceChild("left_armor", CubeListBuilder.create()
                .texOffs(40,112).mirror().addBox(-0.75F,-0.2F,-2.0F,4.0F,12.0F,4.0F, new CubeDeformation(0.3F)).mirror(false)
                        .texOffs(39,79).mirror().addBox(-1.75F,6.2F,-2.0F,5.0F,6.0F,4.0F, new CubeDeformation(0.4F)).mirror(false)
                        .texOffs(39,79).mirror().addBox(-1.75F,4.2F,-2.0F,5.0F,6.0F,4.0F, new CubeDeformation(0.5F)).mirror(false)
                        .texOffs(39,79).mirror().addBox(-1.75F,2.2F,-2.0F,5.0F,6.0F,4.0F, new CubeDeformation(0.6F)).mirror(false)
                , PartPose.offset(0.0F, -1.5F, 0.0F));

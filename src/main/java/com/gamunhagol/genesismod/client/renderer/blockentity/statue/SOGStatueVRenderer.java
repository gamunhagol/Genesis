...
import com.gamunhagol.genesismod.client.model.block.statue.SOGStatueVModel;
...
public class SOGStatueVRenderer implements BlockEntityRenderer<GodStatueGenericBlockEntity> {
    private final SOGStatueVModel model;
    private static final ResourceLocation TEXTURE = new ResourceLocation(GenesisMod.MODID, "textures/block/statue_of_god_v.png");

    public SOGStatueVRenderer(BlockEntityRendererProvider.Context context) {
        this.model = new SOGStatueVModel(context.bakeLayer(ModModelLayers.STATUE_GOD_V_LAYER));
    }

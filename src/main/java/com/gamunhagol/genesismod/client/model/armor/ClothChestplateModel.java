...
public class ClothChestplateModel<T extends LivingEntity> extends HumanoidModel<T>{
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(GenesisMod.MODID, "cloth_robe"), "main");

    public ClothChestplateModel(ModelPart root) {
        super(root);
    }
    ...
    public static LayerDefinition createArmorLayer() {
        ...
        PartDefinition body_armor = body.addOrReplaceChild("body_armor", CubeListBuilder.create()
                        .texOffs(16, 100).addBox(-4.0F, -1.0F, -2.0F, 8.0F, 24.0F, 4.0F, new CubeDeformation(0.75F)),
                PartPose.ZERO);

        PartDefinition left_arm_armor = left_arm.addOrReplaceChild("left_arm_armor", CubeListBuilder.create()
                        .texOffs(40, 100).mirror().addBox(-1.0F, -3.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.75F)).mirror(false),
                PartPose.ZERO);

        PartDefinition right_arm_armor = right_arm.addOrReplaceChild("right_arm_armor", CubeListBuilder.create()
                        .texOffs(40, 100).addBox(-3.0F, -3.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.75F)),
                PartPose.ZERO);

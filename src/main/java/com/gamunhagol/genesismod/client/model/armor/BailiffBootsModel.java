...
public class BailiffBootsModel<T extends LivingEntity> extends HumanoidModel<T> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(GenesisMod.MODID,"bailiff_boots"),"main");

    public BailiffBootsModel(ModelPart pRoot) {
        super(pRoot);
    }

...
public class BailiffLeggingsModel<T extends LivingEntity> extends HumanoidModel<T> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(GenesisMod.MODID,"bailiff_leggings"),"main");

    public BailiffLeggingsModel(ModelPart pRoot) {
        super(pRoot);
    }

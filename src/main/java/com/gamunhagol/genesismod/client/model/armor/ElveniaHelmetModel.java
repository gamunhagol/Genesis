...
public class ElveniaHelmetModel <T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public ElveniaHelmetModel(ModelPart root) {
        super(root);
    }
    ...
    public static LayerDefinition createArmorLayer() {
        ...
        PartDefinition left_eararmor = head.addOrReplaceChild("left_eararmor", CubeListBuilder.create()
        ...
        PartDefinition right_eararmor = head.addOrReplaceChild("right_eararmor", CubeListBuilder.create()
